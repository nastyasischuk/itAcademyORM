...
public class QueryBuilderImplTest {
    private QueryBuilderImpl query = new QueryBuilderImpl(PersonWithSimpleProperColumns.class);
    ...
    public void selectWhereNotBetweenTest() {
        String expected = "SELECT * FROM person WHERE p_id NOT  BETWEEN '10' AND '20';";
